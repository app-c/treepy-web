...
import { BoxTexts, Container, Content, Image, Inova } from './styles'
      ...
      {type === 'a' && (
        <Content>
          ...
          <BoxTexts>
            ...
            <div>
              <p>
                Somos o 1º programa de créditos focado na geração de valor para
                o meio ambiente. Através de compras em estabelecimentos é
                possível acumular créditos e contribuir para o reflorestamento
                de locais no Brasil inteiro. Locais/estabelecimentos
                credenciados para gerar créditos no programa Treepy.
              </p>
              <p>
                Os valores das notas fiscais cadastradas na nossa plataforma
                serão convertidos no programa de créditos e destinados à
              ...
              <p>
                ...
                gerações, aplicando inovação e tecnologia para redução de
                emissões de CO2, gerando valor de investimento num processo que
                é visto como custo.
              </p>
            </div>
